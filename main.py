...
fontmain = 'D:/Term - 4/Pygame/font/Ashford/ashfo.ttf'
font_size = 35
custom_font = pygame.font.Font(font_path, font_size)
startFont = pygame.font.Font(fontmain, 40)
...
startSurface = pygame.Surface(displaySize)
startSurface.fill('#87CEEB')

startKey = pygame.image.load('D:/Term - 4/Pygame/start screen/enter.png').convert_alpha()
startKey = pygame.transform.smoothscale(startKey,(110,90))

# Fill the screen with a blue color
screen.fill('#87CEEB')

#Title
instructions_surface = custom_font.render("Press", True, (255, 255, 255))
instructions_surface2 = custom_font.render("to start", True, (255, 255, 255))

#logo 
logo = pygame.image.load('D:/Term - 4/Pygame/start screen/Brews &.png').convert_alpha()
logo = pygame.transform.smoothscale(logo,(550,550))
...
# Rectangle for food
bread_rect = bread.get_rect(midbottom=(780, 685))
coffee_rect = coffee.get_rect(midbottom=(780, 685))
...
#Start screen
logo_rect = logo.get_rect(center=((displaySize[0] // 2)+50,( displaySize[1] // 2)))
instructions_rect = instructions_surface.get_rect(midbottom =(logo_rect.bottomleft[0]+120, logo_rect.midbottom[1] + 100))
start_rect = startKey.get_rect(midleft = (instructions_rect.midright[0]+40,instructions_rect.midright[1])) #Start screen key
instructions_rect2 = instructions_surface2.get_rect(midleft = (start_rect.midright[0]+40,start_rect.midright[1]))
...
while True:
    ...
    if game_state == START_SCREEN:
        ...
        screen.blit(startKey,start_rect)
